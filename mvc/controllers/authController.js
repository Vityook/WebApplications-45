...
exports.shoppage = (req, res) => {
    // Assuming you want to render a shop page
    res.render('shoppage.ejs'); // Ensure you have a view file named 'shoppage.ejs'
};
// Shop page logic
exports.shoppage = (req, res) => {
    console.log('Shoppage function called'); // Debugging log
    res.render('shoppage.ejs'); // Ensure you have a view file named 'shoppage.ejs'
};
